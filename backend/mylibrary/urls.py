...
from .views import search_books, save_selected_book, routine_complete_detail, user_books, delete_book, user_book_routines
...
urlpatterns = [
    ...
    path('books/<int:book_id>/routines/', user_book_routines, name='user-book-routines'),
]